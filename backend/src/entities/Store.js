...
let Store = (() => {
    ...
    var Store = _classThis = class {
        constructor() {
            ...
            this.createdAt = (__runInitializers(this, _logoUrl_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
            this.categoryId = (__runInitializers(this, _createdAt_extraInitializers), __runInitializers(this, _categoryId_initializers, void 0));
    ...
    (() => {
        ...
        _category_decorators = [(0, typeorm_1.ManyToOne)(() => Category_1.Category), (0, typeorm_1.JoinColumn)({ name: 'categoryId' })];
